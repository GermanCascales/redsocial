    ...
    <div class="flex items-end sm:items-center justify-center min-h-full">
      <div @click.away="isOpen = false" class="modal bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
        ...
        <div class="bg-white px-4 pt-5 sm:p-6">
            <h3 class="text-center text-lg font-medium text-gray-900">Editar comentario</h3>
            <div class="space-y-4 px-4 py-6">
                <div>
                    <textarea wire:model.defer="message" name="message" cols="30" rows="4" class="w-full text-sm bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Escribe un comentario..." x-ref="messageInput"></textarea>
                    <x-jet-input-error for="message" class="text-red text-xs my-1 px-1" />
                </div>
