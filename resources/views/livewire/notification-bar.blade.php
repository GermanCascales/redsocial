<div
    ...
    x-init="Livewire.on('notificationBarOpen', () => {
                isOpen = true
            })"
    x-show="isOpen"
    ...
    <div
        ...
        <div class="flex items-center justify-between">
            ...
            <button @click="isOpen = false" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 rounded-md cursor-pointer">
        ...
        <div class="w-full p-3 mt-8 bg-white rounded flex shadow flex flex-shrink-0">
