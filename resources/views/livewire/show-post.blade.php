...
<div class="buttons-container flex items-center justify-between mt-4 md:mt-6 px-3 md:px-0">
    ...
    <div class="flex items-center space-x-3">
        ...
        <button type="button" class="text-xs @if($likedPost) text-white bg-blue border-blue hover:bg-blue-hover @else bg-gray-200 border-gray-200 hover:border-gray-400 @endif font-semibold uppercase rounded-xl border transition duration-150 ease-in p-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
